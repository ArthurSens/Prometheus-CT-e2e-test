module github.com/ArthurSens/Prometheus-CT-e2e-test
...
replace github.com/prometheus/client_golang => github.com/ArthurSens/client_golang v0.0.0-20230801205726-8e4f899c49a9
